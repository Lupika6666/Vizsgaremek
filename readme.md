...
Ez egy egyszerű E-Könyvtár alkalmazás, amely lehetővé teszi a felhasználók számára, hogy könyveket adjanak hozzá,
megtekintsék a könyvtárban található könyveket, és keresést végezzenek a könyvek között, illetve kölcsönözzenek.
...
- `Kiss Bálint László`: Backend fejlesztés, frontend fejlesztés:
    ...
    - Képfeltöltés és megjelenítés implementálása frontend és backend oldalon

## Dokumentációk

- Backend dokumentáció: `src/backend/README.md`
- Frontend dokumentáció: `src/frontend/README.md`