    ...
    return (
        <div className="card shadow text-center">
            <div className="card-body">
                ...
                <Link className="btn btn-outline-danger m-2" onClick={handleDeleteButton} to="/konyvek">Igen</Link>
                <Link className="btn btn-outline-secondary m-2" to={-1}>Vissza</Link>
            </div>
        </div>
    )
}