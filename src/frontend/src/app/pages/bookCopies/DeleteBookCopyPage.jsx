    ...
    return (
        <div className="card shadow text-center">
            <div className="card-body">
                ...
                <Link className="btn btn-outline-danger m-2" onClick={handleDeleteButton} to="/peldanyok">Igen</Link>
                <Link className="btn btn-outline-secondary m-2" to="/peldanyok">Vissza</Link>
            </div>
        </div>
    )
}